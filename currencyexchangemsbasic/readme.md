...
Run com.rajuankilla20.microservices.currencyconversionservice.CurrencyExchangeServiceApplicationH2 as a Java Application.
...
#### Basic
```
docker container run --publish 8000:8000 rajuankilla20/currency-exchange:0.0.1-SNAPSHOT
```
